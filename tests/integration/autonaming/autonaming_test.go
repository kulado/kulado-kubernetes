...
import (
	...
	"github.com/kulado/kulado-kubernetes/tests"
	"github.com/kulado/kulado/pkg/resource"
	"github.com/kulado/kulado/pkg/resource/deploy/providers"
...
func TestAutonaming(t *testing.T) {
	...
	integration.ProgramTest(t, &integration.ProgramTestOptions{
		Dir:          "step1",
		Dependencies: []string{"@kulado/kubernetes"},
		Quick:        true,
		ExtraRuntimeValidation: func(t *testing.T, stackInfo integration.RuntimeValidationStackInfo) {
			...
			//
			// Assert Pod is successfully given a unique name by Kulado.
			//
			...
			autonamed, _ := openapi.Pluck(pod.Outputs, "metadata", "annotations", "kulado.com/autonamed")
		...
		EditDirs: []integration.EditDir{
			...
			},
			{
				...
				ExtraRuntimeValidation: func(t *testing.T, stackInfo integration.RuntimeValidationStackInfo) {
					...
					//
					// Assert Pod was NOT replaced, and has the same name, previously allocated by Kulado.
					//
			...
			},
			{
				...
				ExtraRuntimeValidation: func(t *testing.T, stackInfo integration.RuntimeValidationStackInfo) {
					...
					//
					// User has specified their own name for the Pod, so we replace it, and Kulado does NOT
					...
					_, autonamed := openapi.Pluck(pod.Outputs, "metadata", "annotations", "kulado.com/autonamed")
