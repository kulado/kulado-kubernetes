...
import (
	...
	"github.com/kulado/kulado/pkg/util/cmdutil"

	"github.com/golang/glog"
	"github.com/pkg/errors"
	"github.com/kulado/kulado-kubernetes/pkg/await/states"
	"github.com/kulado/kulado-kubernetes/pkg/clients"
	"github.com/kulado/kulado-kubernetes/pkg/kinds"
...
func (dia *deploymentInitAwaiter) checkReplicaSetStatus() {
	...
	// to reduce the number of replicas, which would cause subsequent `kulado refresh` to fail, as
	// we would now have fewer replicas than we had requested in the `Deployment` we last submitted
	// when we last ran `kulado up`.
