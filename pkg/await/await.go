...
import (
	...
	"github.com/kulado/kulado-kubernetes/pkg/retry"
	"github.com/kulado/kulado/pkg/diag"
	"github.com/kulado/kulado/pkg/resource"
	kuladoprovider "github.com/kulado/kulado/pkg/resource/provider"
...
type ProviderConfig struct {
	...
	Host    *kuladoprovider.HostClient
	URN     resource.URN
...
func Creation(c CreateConfig) (*unstructured.Unstructured, error) {
	...
	//
	// For more discussion see kulado-kubernetes#239. See also the retry logic `kubectl` uses to
...
func clearStatus(context context.Context, host *kuladoprovider.HostClient, urn resource.URN) error {
