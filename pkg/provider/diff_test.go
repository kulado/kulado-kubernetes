...
type list = []interface{}
type expected = map[string]*kuladorpc.PropertyDiff

func TestPatchToDiff(t *testing.T) {
	var (
		A  = &kuladorpc.PropertyDiff{Kind: kuladorpc.PropertyDiff_ADD}
		D  = &kuladorpc.PropertyDiff{Kind: kuladorpc.PropertyDiff_DELETE, InputDiff: true}
		U  = &kuladorpc.PropertyDiff{Kind: kuladorpc.PropertyDiff_UPDATE}
		AR = &kuladorpc.PropertyDiff{Kind: kuladorpc.PropertyDiff_ADD_REPLACE}
		DR = &kuladorpc.PropertyDiff{Kind: kuladorpc.PropertyDiff_DELETE_REPLACE, InputDiff: true}
		UR = &kuladorpc.PropertyDiff{Kind: kuladorpc.PropertyDiff_UPDATE_REPLACE}
	)
