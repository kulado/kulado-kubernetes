...
// is mistyped. In particular, TrySetLabel will fail if the underlying object has a Kulado computed
// value.
...
// TrySetManagedByLabel attempts to set the `app.kubernetes.io/managed-by` label to the `kulado` key
...
// object has a Kulado computed value.
func TrySetManagedByLabel(obj *unstructured.Unstructured) (bool, error) {
	return TrySetLabel(obj, managedByLabel, "kulado")
}

// HasManagedByLabel returns true if the object has the `app.kubernetes.io/managed-by` label set to `kulado`,
