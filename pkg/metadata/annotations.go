...
// Annotations for internal Kulado use only.
var internalAnnotationPrefixes = []string{AnnotationAutonamed}

// IsInternalAnnotation returns true if the specified annotation has the `kulado.com/` prefix, false otherwise.
