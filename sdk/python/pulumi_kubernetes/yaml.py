...
import requests
import yaml
from kulado_kubernetes.admissionregistration.v1beta1 import *
from kulado_kubernetes.apiextensions.v1beta1 import *
from kulado_kubernetes.apiregistration.v1 import *
from kulado_kubernetes.apiregistration.v1beta1 import *
from kulado_kubernetes.apps.v1 import *
from kulado_kubernetes.apps.v1beta1 import *
from kulado_kubernetes.apps.v1beta2 import *
from kulado_kubernetes.auditregistration.v1alpha1 import *
from kulado_kubernetes.authentication.v1 import *
from kulado_kubernetes.authentication.v1beta1 import *
from kulado_kubernetes.authorization.v1 import *
from kulado_kubernetes.authorization.v1beta1 import *
from kulado_kubernetes.autoscaling.v1 import *
from kulado_kubernetes.autoscaling.v2beta1 import *
from kulado_kubernetes.autoscaling.v2beta2 import *
from kulado_kubernetes.batch.v1 import *
from kulado_kubernetes.batch.v1beta1 import *
from kulado_kubernetes.batch.v2alpha1 import *
from kulado_kubernetes.certificates.v1beta1 import *
from kulado_kubernetes.coordination.v1 import *
from kulado_kubernetes.coordination.v1beta1 import *
from kulado_kubernetes.core.v1 import *
from kulado_kubernetes.events.v1beta1 import *
from kulado_kubernetes.extensions.v1beta1 import *
from kulado_kubernetes.meta.v1 import *
from kulado_kubernetes.networking.v1 import *
from kulado_kubernetes.networking.v1beta1 import *
from kulado_kubernetes.node.v1alpha1 import *
from kulado_kubernetes.node.v1beta1 import *
from kulado_kubernetes.policy.v1beta1 import *
from kulado_kubernetes.rbac.v1 import *
from kulado_kubernetes.rbac.v1alpha1 import *
from kulado_kubernetes.rbac.v1beta1 import *
from kulado_kubernetes.scheduling.v1 import *
from kulado_kubernetes.scheduling.v1alpha1 import *
from kulado_kubernetes.scheduling.v1beta1 import *
from kulado_kubernetes.settings.v1alpha1 import *
from kulado_kubernetes.storage.v1 import *
from kulado_kubernetes.storage.v1alpha1 import *
from kulado_kubernetes.storage.v1beta1 import *
from kulado_kubernetes.apiextensions import CustomResource

from . import tables


class ConfigFile(kulado.ComponentResource):
    """
    ...
    def __init__(
        ...
        if opts is not None:
            ...
            _opts = kulado.ResourceOptions(parent=self)
...
def _build_resources_dict(objs: List[kulado.Output]) -> Dict[kulado.Output, kulado.Output]:
    return {key: value for key, value in objs}


def _parse_yaml_document(
        objects, opts: Optional[kulado.ResourceOptions] = None,
        transformations: Optional[List[Callable]] = None,
        resource_prefix: Optional[str] = None
) -> kulado.Output:
    objs = []
    ...
    return kulado.Output.all(*objs).apply(_build_resources_dict)


def _parse_yaml_object(
        obj, opts: Optional[kulado.ResourceOptions] = None,
        transformations: Optional[List[Callable]] = None,
        resource_prefix: Optional[str] = None
) -> [kulado.Output]:
    """
    ...
    spec = obj.get("spec")
    identifier: kulado.Output = kulado.Output.from_input(metadata["name"])
    if "namespace" in metadata:
        identifier = kulado.Output.from_input(metadata).apply(
            lambda metadata: f"{metadata['namespace']}/{metadata['name']}")
    if resource_prefix:
        identifier = kulado.Output.from_input(identifier).apply(
