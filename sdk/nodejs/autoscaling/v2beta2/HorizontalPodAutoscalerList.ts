...
import { getVersion } from "../../version";
     ...
     */
    export class HorizontalPodAutoscalerList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.autoscaling.v2beta2.HorizontalPodAutoscaler[]>;
       ...
       */
      public readonly kind: kulado.Output<"HorizontalPodAutoscalerList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): HorizontalPodAutoscalerList {
          return new HorizontalPodAutoscalerList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:autoscaling/v2beta2:HorizontalPodAutoscalerList";
      ...
      public static isInstance(obj: any): obj is HorizontalPodAutoscalerList {
          ...
          return obj["__kuladoType"] === HorizontalPodAutoscalerList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.autoscaling.v2beta2.HorizontalPodAutoscalerList, opts?: kulado.CustomResourceOptions) {
          ...
          super(HorizontalPodAutoscalerList.__kuladoType, name, inputs, opts);
      }
    }
