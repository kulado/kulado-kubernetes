...
import { getVersion } from "../../version";
    ...
    export class HorizontalPodAutoscalerList extends kulado.CustomResource {
       ...
       * list of horizontal pod autoscaler objects.
       */
      public readonly items: kulado.Output<outputApi.autoscaling.v1.HorizontalPodAutoscaler[]>;
      ...
      /** @internal */
      private static readonly __kuladoType = "kubernetes:autoscaling/v1:HorizontalPodAutoscalerList";
       ...
       */
      constructor(name: string, args?: inputApi.autoscaling.v1.HorizontalPodAutoscalerList, opts?: kulado.CustomResourceOptions) {
