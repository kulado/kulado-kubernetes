...
import { getVersion } from "../../version";
    ...
    export class HorizontalPodAutoscalerList extends kulado.CustomResource {
       ...
       */
      public readonly apiVersion: kulado.Output<"autoscaling/v2beta1">;

      /**
       * items is the list of horizontal pod autoscaler objects.
       */
      public readonly items: kulado.Output<outputApi.autoscaling.v2beta1.HorizontalPodAutoscaler[]>;
      ...
      /** @internal */
      private static readonly __kuladoType = "kubernetes:autoscaling/v2beta1:HorizontalPodAutoscalerList";
       ...
       */
      constructor(name: string, args?: inputApi.autoscaling.v2beta1.HorizontalPodAutoscalerList, opts?: kulado.CustomResourceOptions) {
