...
import { getVersion } from "../../version";
    ...
    export class LeaseList extends kulado.CustomResource {
       ...
       */
      public readonly items: kulado.Output<outputApi.coordination.v1.Lease[]>;
      ...
      /** @internal */
      private static readonly __kuladoType = "kubernetes:coordination.k8s.io/v1:LeaseList";
       ...
       */
      constructor(name: string, args?: inputApi.coordination.v1.LeaseList, opts?: kulado.CustomResourceOptions) {
