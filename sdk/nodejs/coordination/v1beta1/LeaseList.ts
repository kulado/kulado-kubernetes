...
import { getVersion } from "../../version";
     ...
     */
    export class LeaseList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly apiVersion: kulado.Output<"coordination.k8s.io/v1beta1">;

      /**
       * Items is a list of schema objects.
       */
      public readonly items: kulado.Output<outputApi.coordination.v1beta1.Lease[]>;
       ...
       */
      public readonly kind: kulado.Output<"LeaseList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): LeaseList {
          return new LeaseList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:coordination.k8s.io/v1beta1:LeaseList";
      ...
      public static isInstance(obj: any): obj is LeaseList {
          ...
          return obj["__kuladoType"] === LeaseList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.coordination.v1beta1.LeaseList, opts?: kulado.CustomResourceOptions) {
          ...
          super(LeaseList.__kuladoType, name, inputs, opts);
      }
    }
