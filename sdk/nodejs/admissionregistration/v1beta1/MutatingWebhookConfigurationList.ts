...
import { getVersion } from "../../version";
     ...
     */
    export class MutatingWebhookConfigurationList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.admissionregistration.v1beta1.MutatingWebhookConfiguration[]>;
       ...
       */
      public readonly kind: kulado.Output<"MutatingWebhookConfigurationList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): MutatingWebhookConfigurationList {
          return new MutatingWebhookConfigurationList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:admissionregistration.k8s.io/v1beta1:MutatingWebhookConfigurationList";
      ...
      public static isInstance(obj: any): obj is MutatingWebhookConfigurationList {
          ...
          return obj["__kuladoType"] === MutatingWebhookConfigurationList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.admissionregistration.v1beta1.MutatingWebhookConfigurationList, opts?: kulado.CustomResourceOptions) {
          ...
          super(MutatingWebhookConfigurationList.__kuladoType, name, inputs, opts);
      }
    }
