...
import { getVersion } from "../../version";
     ...
     */
    export class RuntimeClass extends kulado.CustomResource {
      /**
       ...
       */
      public readonly kind: kulado.Output<"RuntimeClass">;
       ...
       */
      public readonly spec: kulado.Output<outputApi.node.v1alpha1.RuntimeClassSpec>;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): RuntimeClass {
          return new RuntimeClass(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:node.k8s.io/v1alpha1:RuntimeClass";
      ...
      public static isInstance(obj: any): obj is RuntimeClass {
          ...
          return obj["__kuladoType"] === RuntimeClass.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.node.v1alpha1.RuntimeClass, opts?: kulado.CustomResourceOptions) {
          ...
          super(RuntimeClass.__kuladoType, name, inputs, opts);
      }
    }
