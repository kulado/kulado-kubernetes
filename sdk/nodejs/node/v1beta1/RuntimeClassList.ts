...
import { getVersion } from "../../version";
    ...
    export class RuntimeClassList extends kulado.CustomResource {
       ...
       */
      public readonly apiVersion: kulado.Output<"node.k8s.io/v1beta1">;

      /**
       * Items is a list of schema objects.
       */
      public readonly items: kulado.Output<outputApi.node.v1beta1.RuntimeClass[]>;
      ...
      /** @internal */
      private static readonly __kuladoType = "kubernetes:node.k8s.io/v1beta1:RuntimeClassList";
       ...
       */
      constructor(name: string, args?: inputApi.node.v1beta1.RuntimeClassList, opts?: kulado.CustomResourceOptions) {
