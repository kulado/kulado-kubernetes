...
import { getVersion } from "../../version";
     ...
     */
    export class CSINode extends kulado.CustomResource {
      /**
       ...
       */
      public readonly kind: kulado.Output<"CSINode">;
       ...
       */
      public readonly spec: kulado.Output<outputApi.storage.v1beta1.CSINodeSpec>;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): CSINode {
          return new CSINode(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:storage.k8s.io/v1beta1:CSINode";
      ...
      public static isInstance(obj: any): obj is CSINode {
          ...
          return obj["__kuladoType"] === CSINode.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.storage.v1beta1.CSINode, opts?: kulado.CustomResourceOptions) {
          ...
          super(CSINode.__kuladoType, name, inputs, opts);
      }
    }
