...
import { getVersion } from "../../version";
     ...
     */
    export class CSINodeList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.storage.v1beta1.CSINode[]>;
       ...
       */
      public readonly kind: kulado.Output<"CSINodeList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): CSINodeList {
          return new CSINodeList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:storage.k8s.io/v1beta1:CSINodeList";
      ...
      public static isInstance(obj: any): obj is CSINodeList {
          ...
          return obj["__kuladoType"] === CSINodeList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.storage.v1beta1.CSINodeList, opts?: kulado.CustomResourceOptions) {
          ...
          super(CSINodeList.__kuladoType, name, inputs, opts);
      }
    }
