...
import { getVersion } from "../../version";
     ...
     */
    export class StorageClassList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.storage.v1beta1.StorageClass[]>;
       ...
       */
      public readonly kind: kulado.Output<"StorageClassList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): StorageClassList {
          return new StorageClassList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:storage.k8s.io/v1beta1:StorageClassList";
      ...
      public static isInstance(obj: any): obj is StorageClassList {
          ...
          return obj["__kuladoType"] === StorageClassList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.storage.v1beta1.StorageClassList, opts?: kulado.CustomResourceOptions) {
          ...
          super(StorageClassList.__kuladoType, name, inputs, opts);
      }
    }
