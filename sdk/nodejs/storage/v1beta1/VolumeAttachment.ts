...
import { getVersion } from "../../version";
     ...
     */
    export class VolumeAttachment extends kulado.CustomResource {
      /**
       ...
       */
      public readonly kind: kulado.Output<"VolumeAttachment">;
       ...
       * system.
       */
      public readonly spec: kulado.Output<outputApi.storage.v1beta1.VolumeAttachmentSpec>;

      /**
       * Status of the VolumeAttachment request. Populated by the entity completing the attach or
       * detach operation, i.e. the external-attacher.
       */
      public readonly status: kulado.Output<outputApi.storage.v1beta1.VolumeAttachmentStatus>;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): VolumeAttachment {
          return new VolumeAttachment(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:storage.k8s.io/v1beta1:VolumeAttachment";
      ...
      public static isInstance(obj: any): obj is VolumeAttachment {
          ...
          return obj["__kuladoType"] === VolumeAttachment.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.storage.v1beta1.VolumeAttachment, opts?: kulado.CustomResourceOptions) {
          ...
          super(VolumeAttachment.__kuladoType, name, inputs, opts);
      }
    }
