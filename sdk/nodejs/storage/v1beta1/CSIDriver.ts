...
import { getVersion } from "../../version";
     ...
     * are non-namespaced.
     */
    export class CSIDriver extends kulado.CustomResource {
      /**
       ...
       */
      public readonly kind: kulado.Output<"CSIDriver">;
       ...
       */
      public readonly spec: kulado.Output<outputApi.storage.v1beta1.CSIDriverSpec>;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): CSIDriver {
          return new CSIDriver(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:storage.k8s.io/v1beta1:CSIDriver";
      ...
      public static isInstance(obj: any): obj is CSIDriver {
          ...
          return obj["__kuladoType"] === CSIDriver.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.storage.v1beta1.CSIDriver, opts?: kulado.CustomResourceOptions) {
          ...
          super(CSIDriver.__kuladoType, name, inputs, opts);
      }
    }
