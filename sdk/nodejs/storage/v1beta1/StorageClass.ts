...
import { getVersion } from "../../version";
     ...
     * ObjectMeta.Name.
     */
    export class StorageClass extends kulado.CustomResource {
      /**
       * AllowVolumeExpansion shows whether the storage class allow volume expand
       */
      public readonly allowVolumeExpansion: kulado.Output<boolean>;
       ...
       */
      public readonly allowedTopologies: kulado.Output<outputApi.core.v1.TopologySelectorTerm[]>;
       ...
       */
      public readonly kind: kulado.Output<"StorageClass">;
       ...
       * is invalid.
       */
      public readonly mountOptions: kulado.Output<string[]>;

      /**
       * Parameters holds the parameters for the provisioner that should create volumes of this
       * storage class.
       */
      public readonly parameters: kulado.Output<{[key: string]: kulado.Output<string>}>;

      /**
       * Provisioner indicates the type of the provisioner.
       */
      public readonly provisioner: kulado.Output<string>;

      /**
       * Dynamically provisioned PersistentVolumes of this storage class are created with this
       * reclaimPolicy. Defaults to Delete.
       */
      public readonly reclaimPolicy: kulado.Output<string>;
       ...
       * enable the VolumeScheduling feature.
       */
      public readonly volumeBindingMode: kulado.Output<string>;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): StorageClass {
          return new StorageClass(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:storage.k8s.io/v1beta1:StorageClass";
      ...
      public static isInstance(obj: any): obj is StorageClass {
          ...
          return obj["__kuladoType"] === StorageClass.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.storage.v1beta1.StorageClass, opts?: kulado.CustomResourceOptions) {
          ...
          super(StorageClass.__kuladoType, name, inputs, opts);
      }
    }
