...
import { getVersion } from "../../version";
    ...
    export class VolumeAttachment extends kulado.CustomResource {
       ...
       * system.
       */
      public readonly spec: kulado.Output<outputApi.storage.v1alpha1.VolumeAttachmentSpec>;

      /**
       * Status of the VolumeAttachment request. Populated by the entity completing the attach or
       * detach operation, i.e. the external-attacher.
       */
      public readonly status: kulado.Output<outputApi.storage.v1alpha1.VolumeAttachmentStatus>;
      ...
      /** @internal */
      private static readonly __kuladoType = "kubernetes:storage.k8s.io/v1alpha1:VolumeAttachment";
       ...
       */
      constructor(name: string, args?: inputApi.storage.v1alpha1.VolumeAttachment, opts?: kulado.CustomResourceOptions) {
