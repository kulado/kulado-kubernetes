...
import { getVersion } from "../../version";
     ...
     */
    export class Status extends kulado.CustomResource {
      /**
       ...
       */
      public readonly code: kulado.Output<number>;
       ...
       */
      public readonly details: kulado.Output<outputApi.meta.v1.StatusDetails>;
       ...
       */
      public readonly kind: kulado.Output<"Status">;
       ...
       */
      public readonly status: kulado.Output<string>;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): Status {
          return new Status(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:Status";
      ...
      public static isInstance(obj: any): obj is Status {
          ...
          return obj["__kuladoType"] === Status.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.meta.v1.Status, opts?: kulado.CustomResourceOptions) {
          ...
          super(Status.__kuladoType, name, inputs, opts);
      }
    }
