...
import { getVersion } from "../../version";
     ...
     */
    export class PriorityClass extends kulado.CustomResource {
      /**
       ...
       */
      public readonly apiVersion: kulado.Output<"scheduling.k8s.io/v1alpha1">;
       ...
       */
      public readonly globalDefault: kulado.Output<boolean>;
       ...
       */
      public readonly kind: kulado.Output<"PriorityClass">;
       ...
       */
      public readonly preemptionPolicy: kulado.Output<string>;
       ...
       */
      public readonly value: kulado.Output<number>;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): PriorityClass {
          return new PriorityClass(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:scheduling.k8s.io/v1alpha1:PriorityClass";
      ...
      public static isInstance(obj: any): obj is PriorityClass {
          ...
          return obj["__kuladoType"] === PriorityClass.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.scheduling.v1alpha1.PriorityClass, opts?: kulado.CustomResourceOptions) {
          ...
          super(PriorityClass.__kuladoType, name, inputs, opts);
      }
    }
