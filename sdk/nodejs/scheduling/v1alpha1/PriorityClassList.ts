...
import { getVersion } from "../../version";
     ...
     */
    export class PriorityClassList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.scheduling.v1alpha1.PriorityClass[]>;
       ...
       */
      public readonly kind: kulado.Output<"PriorityClassList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): PriorityClassList {
          return new PriorityClassList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:scheduling.k8s.io/v1alpha1:PriorityClassList";
      ...
      public static isInstance(obj: any): obj is PriorityClassList {
          ...
          return obj["__kuladoType"] === PriorityClassList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.scheduling.v1alpha1.PriorityClassList, opts?: kulado.CustomResourceOptions) {
          ...
          super(PriorityClassList.__kuladoType, name, inputs, opts);
      }
    }
