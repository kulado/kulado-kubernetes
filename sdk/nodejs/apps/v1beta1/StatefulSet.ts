...
import { getVersion } from "../../version";
     ...
     * identity.
     */
    export class StatefulSet extends kulado.CustomResource {
      /**
       ...
       */
      public readonly kind: kulado.Output<"StatefulSet">;
       ...
       */
      public readonly spec: kulado.Output<outputApi.apps.v1beta1.StatefulSetSpec>;

      /**
       * Status is the current status of Pods in this StatefulSet. This data may be out of date by
       * some window of time.
       */
      public readonly status: kulado.Output<outputApi.apps.v1beta1.StatefulSetStatus>;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): StatefulSet {
          return new StatefulSet(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:apps/v1beta1:StatefulSet";
      ...
      public static isInstance(obj: any): obj is StatefulSet {
          ...
          return obj["__kuladoType"] === StatefulSet.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.apps.v1beta1.StatefulSet, opts?: kulado.CustomResourceOptions) {
          ...
          super(StatefulSet.__kuladoType, name, inputs, opts);
      }
    }
