...
import { getVersion } from "../../version";
     ...
     */
    export class ControllerRevisionList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.apps.v1beta1.ControllerRevision[]>;
       ...
       */
      public readonly kind: kulado.Output<"ControllerRevisionList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): ControllerRevisionList {
          return new ControllerRevisionList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:apps/v1beta1:ControllerRevisionList";
      ...
      public static isInstance(obj: any): obj is ControllerRevisionList {
          ...
          return obj["__kuladoType"] === ControllerRevisionList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.apps.v1beta1.ControllerRevisionList, opts?: kulado.CustomResourceOptions) {
          ...
          super(ControllerRevisionList.__kuladoType, name, inputs, opts);
      }
    }
