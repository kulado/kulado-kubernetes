...
import { getVersion } from "../../version";
     ...
     */
    export class ControllerRevision extends kulado.CustomResource {
      /**
       ...
       */
      public readonly data: kulado.Output<outputApi.pkg.runtime.RawExtension>;
       ...
       */
      public readonly kind: kulado.Output<"ControllerRevision">;
       ...
       */
      public readonly revision: kulado.Output<number>;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): ControllerRevision {
          return new ControllerRevision(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:apps/v1beta1:ControllerRevision";
      ...
      public static isInstance(obj: any): obj is ControllerRevision {
          ...
          return obj["__kuladoType"] === ControllerRevision.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.apps.v1beta1.ControllerRevision, opts?: kulado.CustomResourceOptions) {
          ...
          super(ControllerRevision.__kuladoType, name, inputs, opts);
      }
    }
