...
import { getVersion } from "../../version";
    ...
    export class Deployment extends kulado.CustomResource {
       ...
       */
      public readonly spec: kulado.Output<outputApi.apps.v1beta2.DeploymentSpec>;

      /**
       * Most recently observed status of the Deployment.
       */
      public readonly status: kulado.Output<outputApi.apps.v1beta2.DeploymentStatus>;
      ...
      /** @internal */
      private static readonly __kuladoType = "kubernetes:apps/v1beta2:Deployment";
       ...
       */
      constructor(name: string, args?: inputApi.apps.v1beta2.Deployment, opts?: kulado.CustomResourceOptions) {
