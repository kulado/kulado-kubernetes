...
import { getVersion } from "../../version";
    ...
    export class StatefulSet extends kulado.CustomResource {
       ...
       */
      public readonly spec: kulado.Output<outputApi.apps.v1beta2.StatefulSetSpec>;

      /**
       * Status is the current status of Pods in this StatefulSet. This data may be out of date by
       * some window of time.
       */
      public readonly status: kulado.Output<outputApi.apps.v1beta2.StatefulSetStatus>;
      ...
      /** @internal */
      private static readonly __kuladoType = "kubernetes:apps/v1beta2:StatefulSet";
       ...
       */
      constructor(name: string, args?: inputApi.apps.v1beta2.StatefulSet, opts?: kulado.CustomResourceOptions) {
