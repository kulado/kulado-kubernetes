...
import { getVersion } from "../../version";
    ...
    export class DeploymentList extends kulado.CustomResource {
       ...
       */
      public readonly items: kulado.Output<outputApi.apps.v1.Deployment[]>;
      ...
      /** @internal */
      private static readonly __kuladoType = "kubernetes:apps/v1:DeploymentList";
       ...
       */
      constructor(name: string, args?: inputApi.apps.v1.DeploymentList, opts?: kulado.CustomResourceOptions) {
