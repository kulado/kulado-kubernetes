...
import { getVersion } from "../../version";
    ...
    export class DaemonSet extends kulado.CustomResource {
       ...
       */
      public readonly spec: kulado.Output<outputApi.apps.v1.DaemonSetSpec>;
       ...
       * https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
       */
      public readonly status: kulado.Output<outputApi.apps.v1.DaemonSetStatus>;
      ...
      /** @internal */
      private static readonly __kuladoType = "kubernetes:apps/v1:DaemonSet";
       ...
       */
      constructor(name: string, args?: inputApi.apps.v1.DaemonSet, opts?: kulado.CustomResourceOptions) {
