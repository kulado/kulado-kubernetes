...
import { getVersion } from "../../version";
     ...
     */
    export class AuditSinkList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.auditregistration.v1alpha1.AuditSink[]>;
       ...
       */
      public readonly kind: kulado.Output<"AuditSinkList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): AuditSinkList {
          return new AuditSinkList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:auditregistration.k8s.io/v1alpha1:AuditSinkList";
      ...
      public static isInstance(obj: any): obj is AuditSinkList {
          ...
          return obj["__kuladoType"] === AuditSinkList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.auditregistration.v1alpha1.AuditSinkList, opts?: kulado.CustomResourceOptions) {
          ...
          super(AuditSinkList.__kuladoType, name, inputs, opts);
      }
    }
