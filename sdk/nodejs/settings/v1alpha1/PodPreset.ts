...
import { getVersion } from "../../version";
     ...
     */
    export class PodPreset extends kulado.CustomResource {
      /**
       ...
       */
      public readonly kind: kulado.Output<"PodPreset">;

      
      public readonly metadata: kulado.Output<outputApi.meta.v1.ObjectMeta>;

      
      public readonly spec: kulado.Output<outputApi.settings.v1alpha1.PodPresetSpec>;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): PodPreset {
          return new PodPreset(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:settings.k8s.io/v1alpha1:PodPreset";
      ...
      public static isInstance(obj: any): obj is PodPreset {
          ...
          return obj["__kuladoType"] === PodPreset.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.settings.v1alpha1.PodPreset, opts?: kulado.CustomResourceOptions) {
          ...
          super(PodPreset.__kuladoType, name, inputs, opts);
      }
    }
