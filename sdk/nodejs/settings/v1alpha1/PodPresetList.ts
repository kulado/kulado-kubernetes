...
import { getVersion } from "../../version";
     ...
     */
    export class PodPresetList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly apiVersion: kulado.Output<"settings.k8s.io/v1alpha1">;

      /**
       * Items is a list of schema objects.
       */
      public readonly items: kulado.Output<outputApi.settings.v1alpha1.PodPreset[]>;
       ...
       */
      public readonly kind: kulado.Output<"PodPresetList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): PodPresetList {
          return new PodPresetList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:settings.k8s.io/v1alpha1:PodPresetList";
      ...
      public static isInstance(obj: any): obj is PodPresetList {
          ...
          return obj["__kuladoType"] === PodPresetList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.settings.v1alpha1.PodPresetList, opts?: kulado.CustomResourceOptions) {
          ...
          super(PodPresetList.__kuladoType, name, inputs, opts);
      }
    }
