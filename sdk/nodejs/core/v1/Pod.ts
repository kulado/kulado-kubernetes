...
import { getVersion } from "../../version";
     ...
     */
    export class Pod extends kulado.CustomResource {
      /**
       ...
       */
      public readonly kind: kulado.Output<"Pod">;
       ...
       */
      public readonly spec: kulado.Output<outputApi.core.v1.PodSpec>;
       ...
       * https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
       */
      public readonly status: kulado.Output<outputApi.core.v1.PodStatus>;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): Pod {
          return new Pod(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:Pod";
      ...
      public static isInstance(obj: any): obj is Pod {
          ...
          return obj["__kuladoType"] === Pod.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.Pod, opts?: kulado.CustomResourceOptions) {
          ...
          super(Pod.__kuladoType, name, inputs, opts);
      }
    }
