...
import { getVersion } from "../../version";
     ...
     */
    export class NodeList extends kulado.CustomResource {
      /**
       ...
       * List of nodes
       */
      public readonly items: kulado.Output<outputApi.core.v1.Node[]>;
       ...
       */
      public readonly kind: kulado.Output<"NodeList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): NodeList {
          return new NodeList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:NodeList";
      ...
      public static isInstance(obj: any): obj is NodeList {
          ...
          return obj["__kuladoType"] === NodeList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.NodeList, opts?: kulado.CustomResourceOptions) {
          ...
          super(NodeList.__kuladoType, name, inputs, opts);
      }
    }
