...
import { getVersion } from "../../version";
     ...
     */
    export class ConfigMapList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.core.v1.ConfigMap[]>;
       ...
       */
      public readonly kind: kulado.Output<"ConfigMapList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): ConfigMapList {
          return new ConfigMapList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:ConfigMapList";
      ...
      public static isInstance(obj: any): obj is ConfigMapList {
          ...
          return obj["__kuladoType"] === ConfigMapList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.ConfigMapList, opts?: kulado.CustomResourceOptions) {
          ...
          super(ConfigMapList.__kuladoType, name, inputs, opts);
      }
    }
