...
import { getVersion } from "../../version";
     ...
     */
    export class SecretList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.core.v1.Secret[]>;
       ...
       */
      public readonly kind: kulado.Output<"SecretList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): SecretList {
          return new SecretList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:SecretList";
      ...
      public static isInstance(obj: any): obj is SecretList {
          ...
          return obj["__kuladoType"] === SecretList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.SecretList, opts?: kulado.CustomResourceOptions) {
          ...
          super(SecretList.__kuladoType, name, inputs, opts);
      }
    }
