...
import { getVersion } from "../../version";
    ...
    export class Namespace extends kulado.CustomResource {
       ...
       */
      public readonly kind: kulado.Output<"Namespace">;
       ...
       */
      public readonly spec: kulado.Output<outputApi.core.v1.NamespaceSpec>;

      /**
       * Status describes the current status of a Namespace. More info:
       * https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
       */
      public readonly status: kulado.Output<outputApi.core.v1.NamespaceStatus>;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): Namespace {
          return new Namespace(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:Namespace";
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.Namespace, opts?: kulado.CustomResourceOptions) {
