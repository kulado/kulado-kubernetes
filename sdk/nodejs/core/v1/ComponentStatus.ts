...
import { getVersion } from "../../version";
     ...
     */
    export class ComponentStatus extends kulado.CustomResource {
      /**
       ...
       */
      public readonly conditions: kulado.Output<outputApi.core.v1.ComponentCondition[]>;
       ...
       */
      public readonly kind: kulado.Output<"ComponentStatus">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): ComponentStatus {
          return new ComponentStatus(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:ComponentStatus";
      ...
      public static isInstance(obj: any): obj is ComponentStatus {
          ...
          return obj["__kuladoType"] === ComponentStatus.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.ComponentStatus, opts?: kulado.CustomResourceOptions) {
          ...
          super(ComponentStatus.__kuladoType, name, inputs, opts);
      }
    }
