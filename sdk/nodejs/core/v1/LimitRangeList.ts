...
import { getVersion } from "../../version";
     ...
     */
    export class LimitRangeList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.core.v1.LimitRange[]>;
       ...
       */
      public readonly kind: kulado.Output<"LimitRangeList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): LimitRangeList {
          return new LimitRangeList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:LimitRangeList";
      ...
      public static isInstance(obj: any): obj is LimitRangeList {
          ...
          return obj["__kuladoType"] === LimitRangeList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.LimitRangeList, opts?: kulado.CustomResourceOptions) {
          ...
          super(LimitRangeList.__kuladoType, name, inputs, opts);
      }
    }
