...
import { getVersion } from "../../version";
     ...
     *  ]
     */
    export class Endpoints extends kulado.CustomResource {
      /**
       ...
       */
      public readonly kind: kulado.Output<"Endpoints">;
       ...
       */
      public readonly subsets: kulado.Output<outputApi.core.v1.EndpointSubset[]>;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): Endpoints {
          return new Endpoints(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:Endpoints";
      ...
      public static isInstance(obj: any): obj is Endpoints {
          ...
          return obj["__kuladoType"] === Endpoints.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.Endpoints, opts?: kulado.CustomResourceOptions) {
          ...
          super(Endpoints.__kuladoType, name, inputs, opts);
      }
    }
