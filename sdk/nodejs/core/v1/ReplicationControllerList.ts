...
import { getVersion } from "../../version";
     ...
     */
    export class ReplicationControllerList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.core.v1.ReplicationController[]>;
       ...
       */
      public readonly kind: kulado.Output<"ReplicationControllerList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): ReplicationControllerList {
          return new ReplicationControllerList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:ReplicationControllerList";
      ...
      public static isInstance(obj: any): obj is ReplicationControllerList {
          ...
          return obj["__kuladoType"] === ReplicationControllerList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.ReplicationControllerList, opts?: kulado.CustomResourceOptions) {
          ...
          super(ReplicationControllerList.__kuladoType, name, inputs, opts);
      }
    }
