...
import { getVersion } from "../../version";
     ...
     */
    export class ReplicationController extends kulado.CustomResource {
      /**
       ...
       */
      public readonly kind: kulado.Output<"ReplicationController">;
       ...
       */
      public readonly spec: kulado.Output<outputApi.core.v1.ReplicationControllerSpec>;
       ...
       */
      public readonly status: kulado.Output<outputApi.core.v1.ReplicationControllerStatus>;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): ReplicationController {
          return new ReplicationController(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:ReplicationController";
      ...
      public static isInstance(obj: any): obj is ReplicationController {
          ...
          return obj["__kuladoType"] === ReplicationController.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.ReplicationController, opts?: kulado.CustomResourceOptions) {
          ...
          super(ReplicationController.__kuladoType, name, inputs, opts);
      }
    }
