...
import { getVersion } from "../../version";
     ...
     */
    export class ResourceQuotaList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.core.v1.ResourceQuota[]>;
       ...
       */
      public readonly kind: kulado.Output<"ResourceQuotaList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): ResourceQuotaList {
          return new ResourceQuotaList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:ResourceQuotaList";
      ...
      public static isInstance(obj: any): obj is ResourceQuotaList {
          ...
          return obj["__kuladoType"] === ResourceQuotaList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.ResourceQuotaList, opts?: kulado.CustomResourceOptions) {
          ...
          super(ResourceQuotaList.__kuladoType, name, inputs, opts);
      }
    }
