...
import { getVersion } from "../../version";
     ...
     */
    export class ServiceList extends kulado.CustomResource {
      /**
       ...
       * List of services
       */
      public readonly items: kulado.Output<outputApi.core.v1.Service[]>;
       ...
       */
      public readonly kind: kulado.Output<"ServiceList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): ServiceList {
          return new ServiceList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:ServiceList";
      ...
      public static isInstance(obj: any): obj is ServiceList {
          ...
          return obj["__kuladoType"] === ServiceList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.ServiceList, opts?: kulado.CustomResourceOptions) {
          ...
          super(ServiceList.__kuladoType, name, inputs, opts);
      }
    }
