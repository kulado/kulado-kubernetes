...
import { getVersion } from "../../version";
     ...
     */
    export class ComponentStatusList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.core.v1.ComponentStatus[]>;
       ...
       */
      public readonly kind: kulado.Output<"ComponentStatusList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): ComponentStatusList {
          return new ComponentStatusList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:ComponentStatusList";
      ...
      public static isInstance(obj: any): obj is ComponentStatusList {
          ...
          return obj["__kuladoType"] === ComponentStatusList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.ComponentStatusList, opts?: kulado.CustomResourceOptions) {
          ...
          super(ComponentStatusList.__kuladoType, name, inputs, opts);
      }
    }
