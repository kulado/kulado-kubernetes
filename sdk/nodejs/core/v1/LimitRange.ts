...
import { getVersion } from "../../version";
     ...
     */
    export class LimitRange extends kulado.CustomResource {
      /**
       ...
       */
      public readonly kind: kulado.Output<"LimitRange">;
       ...
       */
      public readonly spec: kulado.Output<outputApi.core.v1.LimitRangeSpec>;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): LimitRange {
          return new LimitRange(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:LimitRange";
      ...
      public static isInstance(obj: any): obj is LimitRange {
          ...
          return obj["__kuladoType"] === LimitRange.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.LimitRange, opts?: kulado.CustomResourceOptions) {
          ...
          super(LimitRange.__kuladoType, name, inputs, opts);
      }
    }
