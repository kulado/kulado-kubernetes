...
import { getVersion } from "../../version";
     ...
     */
    export class PodList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.core.v1.Pod[]>;
       ...
       */
      public readonly kind: kulado.Output<"PodList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): PodList {
          return new PodList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:PodList";
      ...
      public static isInstance(obj: any): obj is PodList {
          ...
          return obj["__kuladoType"] === PodList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.PodList, opts?: kulado.CustomResourceOptions) {
          ...
          super(PodList.__kuladoType, name, inputs, opts);
      }
    }
