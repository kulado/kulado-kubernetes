...
import { getVersion } from "../../version";
     ...
     */
    export class ServiceAccountList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.core.v1.ServiceAccount[]>;
       ...
       */
      public readonly kind: kulado.Output<"ServiceAccountList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): ServiceAccountList {
          return new ServiceAccountList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:ServiceAccountList";
      ...
      public static isInstance(obj: any): obj is ServiceAccountList {
          ...
          return obj["__kuladoType"] === ServiceAccountList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.ServiceAccountList, opts?: kulado.CustomResourceOptions) {
          ...
          super(ServiceAccountList.__kuladoType, name, inputs, opts);
      }
    }
