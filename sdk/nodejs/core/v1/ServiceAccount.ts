...
import { getVersion } from "../../version";
     ...
     * secrets
     */
    export class ServiceAccount extends kulado.CustomResource {
      /**
       ...
       */
      public readonly automountServiceAccountToken: kulado.Output<boolean>;
       ...
       */
      public readonly imagePullSecrets: kulado.Output<outputApi.core.v1.LocalObjectReference[]>;
       ...
       */
      public readonly kind: kulado.Output<"ServiceAccount">;
       ...
       */
      public readonly secrets: kulado.Output<outputApi.core.v1.ObjectReference[]>;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): ServiceAccount {
          return new ServiceAccount(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:ServiceAccount";
      ...
      public static isInstance(obj: any): obj is ServiceAccount {
          ...
          return obj["__kuladoType"] === ServiceAccount.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.ServiceAccount, opts?: kulado.CustomResourceOptions) {
          ...
          super(ServiceAccount.__kuladoType, name, inputs, opts);
      }
    }
