...
import { getVersion } from "../../version";
    ...
    export class Secret extends kulado.CustomResource {
       ...
       */
      public readonly data: kulado.Output<object>;
       ...
       */
      public readonly kind: kulado.Output<"Secret">;
       ...
       */
      public readonly stringData: kulado.Output<{[key: string]: kulado.Output<string>}>;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): Secret {
          return new Secret(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:Secret";
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.Secret, opts?: kulado.CustomResourceOptions) {
