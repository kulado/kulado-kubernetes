...
import { getVersion } from "../../version";
     ...
     */
    export class EndpointsList extends kulado.CustomResource {
      /**
       ...
       * List of endpoints.
       */
      public readonly items: kulado.Output<outputApi.core.v1.Endpoints[]>;
       ...
       */
      public readonly kind: kulado.Output<"EndpointsList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): EndpointsList {
          return new EndpointsList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:EndpointsList";
      ...
      public static isInstance(obj: any): obj is EndpointsList {
          ...
          return obj["__kuladoType"] === EndpointsList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.EndpointsList, opts?: kulado.CustomResourceOptions) {
          ...
          super(EndpointsList.__kuladoType, name, inputs, opts);
      }
    }
