...
import { getVersion } from "../../version";
     ...
     */
    export class Binding extends kulado.CustomResource {
      /**
       ...
       */
      public readonly kind: kulado.Output<"Binding">;
       ...
       */
      public readonly target: kulado.Output<outputApi.core.v1.ObjectReference>;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): Binding {
          return new Binding(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:Binding";
      ...
      public static isInstance(obj: any): obj is Binding {
          ...
          return obj["__kuladoType"] === Binding.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.Binding, opts?: kulado.CustomResourceOptions) {
          ...
          super(Binding.__kuladoType, name, inputs, opts);
      }
    }
