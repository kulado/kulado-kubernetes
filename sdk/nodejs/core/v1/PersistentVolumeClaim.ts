...
import { getVersion } from "../../version";
     ...
     */
    export class PersistentVolumeClaim extends kulado.CustomResource {
      /**
       ...
       */
      public readonly kind: kulado.Output<"PersistentVolumeClaim">;
       ...
       */
      public readonly spec: kulado.Output<outputApi.core.v1.PersistentVolumeClaimSpec>;
       ...
       * https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims
       */
      public readonly status: kulado.Output<outputApi.core.v1.PersistentVolumeClaimStatus>;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): PersistentVolumeClaim {
          return new PersistentVolumeClaim(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:PersistentVolumeClaim";
      ...
      public static isInstance(obj: any): obj is PersistentVolumeClaim {
          ...
          return obj["__kuladoType"] === PersistentVolumeClaim.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.PersistentVolumeClaim, opts?: kulado.CustomResourceOptions) {
          ...
          super(PersistentVolumeClaim.__kuladoType, name, inputs, opts);
      }
    }
