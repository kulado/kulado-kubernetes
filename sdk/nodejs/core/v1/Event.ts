...
import { getVersion } from "../../version";
    ...
    export class Event extends kulado.CustomResource {
       ...
       */
      public readonly count: kulado.Output<number>;
       ...
       */
      public readonly firstTimestamp: kulado.Output<string>;

      /**
       * The object that this event is about.
       */
      public readonly involvedObject: kulado.Output<outputApi.core.v1.ObjectReference>;
       ...
       */
      public readonly lastTimestamp: kulado.Output<string>;

      /**
       * A human-readable description of the status of this operation.
       */
      public readonly message: kulado.Output<string>;
       ...
       */
      public readonly reportingComponent: kulado.Output<string>;
       ...
       */
      public readonly series: kulado.Output<outputApi.core.v1.EventSeries>;

      /**
       * The component reporting this event. Should be a short machine understandable string.
       */
      public readonly source: kulado.Output<outputApi.core.v1.EventSource>;
      ...
      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:Event";
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.Event, opts?: kulado.CustomResourceOptions) {
