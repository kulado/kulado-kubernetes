...
import { getVersion } from "../../version";
     ...
     */
    export class ConfigMap extends kulado.CustomResource {
      /**
       ...
       */
      public readonly binaryData: kulado.Output<object>;
       ...
       */
      public readonly data: kulado.Output<{[key: string]: kulado.Output<string>}>;
       ...
       */
      public readonly kind: kulado.Output<"ConfigMap">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): ConfigMap {
          return new ConfigMap(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:ConfigMap";
      ...
      public static isInstance(obj: any): obj is ConfigMap {
          ...
          return obj["__kuladoType"] === ConfigMap.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.ConfigMap, opts?: kulado.CustomResourceOptions) {
          ...
          super(ConfigMap.__kuladoType, name, inputs, opts);
      }
    }
