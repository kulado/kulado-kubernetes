...
import { getVersion } from "../../version";
     ...
     */
    export class PersistentVolumeClaimList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.core.v1.PersistentVolumeClaim[]>;
       ...
       */
      public readonly kind: kulado.Output<"PersistentVolumeClaimList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): PersistentVolumeClaimList {
          return new PersistentVolumeClaimList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:PersistentVolumeClaimList";
      ...
      public static isInstance(obj: any): obj is PersistentVolumeClaimList {
          ...
          return obj["__kuladoType"] === PersistentVolumeClaimList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.PersistentVolumeClaimList, opts?: kulado.CustomResourceOptions) {
          ...
          super(PersistentVolumeClaimList.__kuladoType, name, inputs, opts);
      }
    }
