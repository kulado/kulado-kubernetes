...
import { getVersion } from "../../version";
     ...
     */
    export class PodTemplate extends kulado.CustomResource {
      /**
       ...
       */
      public readonly kind: kulado.Output<"PodTemplate">;
       ...
       */
      public readonly template: kulado.Output<outputApi.core.v1.PodTemplateSpec>;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): PodTemplate {
          return new PodTemplate(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:PodTemplate";
      ...
      public static isInstance(obj: any): obj is PodTemplate {
          ...
          return obj["__kuladoType"] === PodTemplate.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.PodTemplate, opts?: kulado.CustomResourceOptions) {
          ...
          super(PodTemplate.__kuladoType, name, inputs, opts);
      }
    }
