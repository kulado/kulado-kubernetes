...
import { getVersion } from "../../version";
    ...
    export class Service extends kulado.CustomResource {
       ...
       */
      public readonly kind: kulado.Output<"Service">;
       ...
       */
      public readonly spec: kulado.Output<outputApi.core.v1.ServiceSpec>;
       ...
       */
      public readonly status: kulado.Output<outputApi.core.v1.ServiceStatus>;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): Service {
          return new Service(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:Service";
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.Service, opts?: kulado.CustomResourceOptions) {
