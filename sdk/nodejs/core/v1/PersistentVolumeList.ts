...
import { getVersion } from "../../version";
     ...
     */
    export class PersistentVolumeList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.core.v1.PersistentVolume[]>;
       ...
       */
      public readonly kind: kulado.Output<"PersistentVolumeList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): PersistentVolumeList {
          return new PersistentVolumeList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:PersistentVolumeList";
      ...
      public static isInstance(obj: any): obj is PersistentVolumeList {
          ...
          return obj["__kuladoType"] === PersistentVolumeList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.PersistentVolumeList, opts?: kulado.CustomResourceOptions) {
          ...
          super(PersistentVolumeList.__kuladoType, name, inputs, opts);
      }
    }
