...
import { getVersion } from "../../version";
     ...
     */
    export class NamespaceList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.core.v1.Namespace[]>;
       ...
       */
      public readonly kind: kulado.Output<"NamespaceList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): NamespaceList {
          return new NamespaceList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:core/v1:NamespaceList";
      ...
      public static isInstance(obj: any): obj is NamespaceList {
          ...
          return obj["__kuladoType"] === NamespaceList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.core.v1.NamespaceList, opts?: kulado.CustomResourceOptions) {
          ...
          super(NamespaceList.__kuladoType, name, inputs, opts);
      }
    }
