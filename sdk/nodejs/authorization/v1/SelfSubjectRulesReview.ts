...
import { getVersion } from "../../version";
    ...
    export class SelfSubjectRulesReview extends kulado.CustomResource {
       ...
       */
      public readonly spec: kulado.Output<outputApi.authorization.v1.SelfSubjectRulesReviewSpec>;

      /**
       * Status is filled in by the server and indicates the set of actions a user can perform.
       */
      public readonly status: kulado.Output<outputApi.authorization.v1.SubjectRulesReviewStatus>;
      ...
      /** @internal */
      private static readonly __kuladoType = "kubernetes:authorization.k8s.io/v1:SelfSubjectRulesReview";
       ...
       */
      constructor(name: string, args?: inputApi.authorization.v1.SelfSubjectRulesReview, opts?: kulado.CustomResourceOptions) {
