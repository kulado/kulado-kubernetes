...
export interface CustomResourceArgs {
     ...
     */
    apiVersion: kulado.Input<string>;
     ...
     */
    kind: kulado.Input<string>;

    /**
     * Standard object metadata; More info:
     * https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata.
     */
    metadata?: kulado.Input<inputApi.meta.v1.ObjectMeta>;
    [othersFields: string]: kulado.Input<any>;
}
 ...
 */
export interface CustomResourceGetOptions extends kulado.CustomResourceOptions {
    /**
     ...
     * <name>.
     */
    id: kulado.Input<kulado.ID>;
}

/**
 * CustomResource represents an instance of a CustomResourceDefinition (CRD). For example, the
 * CoreOS Prometheus operator exposes a CRD `monitoring.coreos.com/ServiceMonitor`; to
 * instantiate this as a Kulado resource, one could call `new CustomResource`, passing the
 * `ServiceMonitor` resource definition as an argument.
 */
export class CustomResource extends kulado.CustomResource {
    /**
     * APIVersion defines the versioned schema of this representation of an object. Servers should
     * convert recognized schemas to the latest internal value, and may reject unrecognized
     * values. More info:
     * https://git.k8s.io/community/contributors/devel/api-conventions.md#resources
     */
    public readonly apiVersion: kulado.Output<string>;
    ...
    public static get(name: string, opts: CustomResourceGetOptions): CustomResource {
        // NOTE: `selectOpts` will be type `kulado.CustomResource`. If we add a field that does
     ...
     */
    constructor(name: string, args: CustomResourceArgs, opts?: kulado.CustomResourceOptions) {
