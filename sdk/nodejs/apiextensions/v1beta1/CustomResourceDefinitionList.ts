...
import { getVersion } from "../../version";
     ...
     */
    export class CustomResourceDefinitionList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.apiextensions.v1beta1.CustomResourceDefinition[]>;
       ...
       */
      public readonly kind: kulado.Output<"CustomResourceDefinitionList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): CustomResourceDefinitionList {
          return new CustomResourceDefinitionList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:apiextensions.k8s.io/v1beta1:CustomResourceDefinitionList";
      ...
      public static isInstance(obj: any): obj is CustomResourceDefinitionList {
          ...
          return obj["__kuladoType"] === CustomResourceDefinitionList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.apiextensions.v1beta1.CustomResourceDefinitionList, opts?: kulado.CustomResourceOptions) {
          ...
          super(CustomResourceDefinitionList.__kuladoType, name, inputs, opts);
      }
    }
