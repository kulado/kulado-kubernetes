...
import { getVersion } from "../../version";
    ...
    export class NetworkPolicy extends kulado.CustomResource {
       ...
       */
      public readonly spec: kulado.Output<outputApi.networking.v1.NetworkPolicySpec>;
      ...
      /** @internal */
      private static readonly __kuladoType = "kubernetes:networking.k8s.io/v1:NetworkPolicy";
       ...
       */
      constructor(name: string, args?: inputApi.networking.v1.NetworkPolicy, opts?: kulado.CustomResourceOptions) {
