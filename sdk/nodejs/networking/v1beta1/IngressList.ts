...
import { getVersion } from "../../version";
    ...
    export class IngressList extends kulado.CustomResource {
       ...
       */
      public readonly items: kulado.Output<outputApi.networking.v1beta1.Ingress[]>;
      ...
      /** @internal */
      private static readonly __kuladoType = "kubernetes:networking.k8s.io/v1beta1:IngressList";
       ...
       */
      constructor(name: string, args?: inputApi.networking.v1beta1.IngressList, opts?: kulado.CustomResourceOptions) {
