...
import { getVersion } from "../../version";
    ...
    export class ClusterRole extends kulado.CustomResource {
       ...
       */
      public readonly aggregationRule: kulado.Output<outputApi.rbac.v1alpha1.AggregationRule>;
      ...
      /** @internal */
      private static readonly __kuladoType = "kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRole";
       ...
       */
      constructor(name: string, args?: inputApi.rbac.v1alpha1.ClusterRole, opts?: kulado.CustomResourceOptions) {
