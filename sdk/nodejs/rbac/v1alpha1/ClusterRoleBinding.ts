...
import { getVersion } from "../../version";
    ...
    export class ClusterRoleBinding extends kulado.CustomResource {
       ...
       */
      public readonly roleRef: kulado.Output<outputApi.rbac.v1alpha1.RoleRef>;

      /**
       * Subjects holds references to the objects the role applies to.
       */
      public readonly subjects: kulado.Output<outputApi.rbac.v1alpha1.Subject[]>;
      ...
      /** @internal */
      private static readonly __kuladoType = "kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRoleBinding";
       ...
       */
      constructor(name: string, args?: inputApi.rbac.v1alpha1.ClusterRoleBinding, opts?: kulado.CustomResourceOptions) {
