...
import { getVersion } from "../../version";
    ...
    export class RoleList extends kulado.CustomResource {
       ...
       */
      public readonly items: kulado.Output<outputApi.rbac.v1alpha1.Role[]>;
      ...
      /** @internal */
      private static readonly __kuladoType = "kubernetes:rbac.authorization.k8s.io/v1alpha1:RoleList";
       ...
       */
      constructor(name: string, args?: inputApi.rbac.v1alpha1.RoleList, opts?: kulado.CustomResourceOptions) {
