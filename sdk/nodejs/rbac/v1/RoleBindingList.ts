...
import { getVersion } from "../../version";
    ...
    export class RoleBindingList extends kulado.CustomResource {
       ...
       */
      public readonly items: kulado.Output<outputApi.rbac.v1.RoleBinding[]>;
      ...
      /** @internal */
      private static readonly __kuladoType = "kubernetes:rbac.authorization.k8s.io/v1:RoleBindingList";
       ...
       */
      constructor(name: string, args?: inputApi.rbac.v1.RoleBindingList, opts?: kulado.CustomResourceOptions) {
