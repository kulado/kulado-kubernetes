...
import { getVersion } from "../../version";
    ...
    export class ClusterRole extends kulado.CustomResource {
       ...
       */
      public readonly aggregationRule: kulado.Output<outputApi.rbac.v1beta1.AggregationRule>;
       ...
       */
      public readonly rules: kulado.Output<outputApi.rbac.v1beta1.PolicyRule[]>;
      ...
      /** @internal */
      private static readonly __kuladoType = "kubernetes:rbac.authorization.k8s.io/v1beta1:ClusterRole";
       ...
       */
      constructor(name: string, args?: inputApi.rbac.v1beta1.ClusterRole, opts?: kulado.CustomResourceOptions) {
