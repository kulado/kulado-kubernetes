...
import { getVersion } from "../../version";
     ...
     */
    export class RoleBindingList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.rbac.v1beta1.RoleBinding[]>;
       ...
       */
      public readonly kind: kulado.Output<"RoleBindingList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): RoleBindingList {
          return new RoleBindingList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:rbac.authorization.k8s.io/v1beta1:RoleBindingList";
      ...
      public static isInstance(obj: any): obj is RoleBindingList {
          ...
          return obj["__kuladoType"] === RoleBindingList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.rbac.v1beta1.RoleBindingList, opts?: kulado.CustomResourceOptions) {
          ...
          super(RoleBindingList.__kuladoType, name, inputs, opts);
      }
    }
