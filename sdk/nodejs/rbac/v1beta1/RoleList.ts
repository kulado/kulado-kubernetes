...
import { getVersion } from "../../version";
     ...
     */
    export class RoleList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.rbac.v1beta1.Role[]>;
       ...
       */
      public readonly kind: kulado.Output<"RoleList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): RoleList {
          return new RoleList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:rbac.authorization.k8s.io/v1beta1:RoleList";
      ...
      public static isInstance(obj: any): obj is RoleList {
          ...
          return obj["__kuladoType"] === RoleList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.rbac.v1beta1.RoleList, opts?: kulado.CustomResourceOptions) {
          ...
          super(RoleList.__kuladoType, name, inputs, opts);
      }
    }
