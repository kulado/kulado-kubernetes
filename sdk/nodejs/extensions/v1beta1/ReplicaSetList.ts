...
import { getVersion } from "../../version";
     ...
     */
    export class ReplicaSetList extends kulado.CustomResource {
      /**
       ...
       */
      public readonly items: kulado.Output<outputApi.extensions.v1beta1.ReplicaSet[]>;
       ...
       */
      public readonly kind: kulado.Output<"ReplicaSetList">;
       ...
       */
      public static get(name: string, id: kulado.Input<kulado.ID>, opts?: kulado.CustomResourceOptions): ReplicaSetList {
          return new ReplicaSetList(name, undefined, { ...opts, id: id });
      }

      /** @internal */
      private static readonly __kuladoType = "kubernetes:extensions/v1beta1:ReplicaSetList";
      ...
      public static isInstance(obj: any): obj is ReplicaSetList {
          ...
          return obj["__kuladoType"] === ReplicaSetList.__kuladoType;
      }
       ...
       */
      constructor(name: string, args?: inputApi.extensions.v1beta1.ReplicaSetList, opts?: kulado.CustomResourceOptions) {
          ...
          super(ReplicaSetList.__kuladoType, name, inputs, opts);
      }
    }
