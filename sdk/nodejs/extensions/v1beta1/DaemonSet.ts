...
import { getVersion } from "../../version";
    ...
    export class DaemonSet extends kulado.CustomResource {
       ...
       */
      public readonly spec: kulado.Output<outputApi.extensions.v1beta1.DaemonSetSpec>;
       ...
       * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
       */
      public readonly status: kulado.Output<outputApi.extensions.v1beta1.DaemonSetStatus>;
      ...
      /** @internal */
      private static readonly __kuladoType = "kubernetes:extensions/v1beta1:DaemonSet";
       ...
       */
      constructor(name: string, args?: inputApi.extensions.v1beta1.DaemonSet, opts?: kulado.CustomResourceOptions) {
