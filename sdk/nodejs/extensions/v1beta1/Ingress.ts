...
import { getVersion } from "../../version";
    ...
    export class Ingress extends kulado.CustomResource {
       ...
       */
      public readonly spec: kulado.Output<outputApi.extensions.v1beta1.IngressSpec>;

      /**
       * Status is the current state of the Ingress. More info:
       * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
       */
      public readonly status: kulado.Output<outputApi.extensions.v1beta1.IngressStatus>;
      ...
      /** @internal */
      private static readonly __kuladoType = "kubernetes:extensions/v1beta1:Ingress";
       ...
       */
      constructor(name: string, args?: inputApi.extensions.v1beta1.Ingress, opts?: kulado.CustomResourceOptions) {
